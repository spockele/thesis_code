...
# ----------------------------------------------------------------------------------------------------------------------
#     spectrogram = pd.read_csv(os.path.join(proj.project_path, 'spectrograms', 'spectrogram_055ms_rec_0.csv'),
...
#     spio.wavfile.write('055ms_rec0_1.wav', int(f_s_desired), wav_dat)
